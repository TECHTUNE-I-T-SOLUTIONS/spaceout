...
const HubConfigSchema = new Schema<IHubConfig>(
  {
    ...
    heroBadge: { type: String, default: 'SPACEOUT HUB' },
    heroTitle: {
      type: String,
    ...
    heroSubtitle: {
      type: String,
      default:
        'SpaceOut Hub runs hands-on trainings for kids and teens — graphics design, web development, ICT & computer appreciation, digital skills, AI and more. Small groups, experienced instructors and real projects from day one.',
    },
    heroImage: { type: String },
    heroSecondaryImage: { type: String },
    aboutImage: { type: String },

    aboutTitle: { type: String, default: 'What is SpaceOut Hub?' },
    aboutText: {
      type: String,
      default:
        'SpaceOut Hub is the training arm of SpaceOut — a dedicated space for holiday bootcamps and practical tech trainings. Students and beginners learn hands-on from experienced instructors, complete real projects and leave with skills they can actually use.',
    },
    ...
    galleryTitle: { type: String, default: 'From Our Trainings' },
    gallerySubtitle: {
      type: String,
    ...
    ctaSubtitle: {
      type: String,
      default: 'Reserve your spot in the next SpaceOut Hub training.',
    },
